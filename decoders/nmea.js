...
(function(){
  var ref$, dropWhile, takeWhile, span, drop, floor, moment, length, exspan, buffer, unpack, decoders, vtgMode, gnssMode, parseDdmm, invalid, checksum;
  ref$ = require('prelude-ls').Str, dropWhile = ref$.dropWhile, takeWhile = ref$.takeWhile, span = ref$.span;
  ref$ = require('prelude-ls'), drop = ref$.drop, floor = ref$.floor;
