...
(function(){
  var ref$, dropWhile, takeWhile, span, drop, floor, splitAt, unpack, moment, length, toArray, unpackNmea, exspan, buffer, decoders, multiSplit, gnssMode, gsaMode, gsaCalc, vtgMode, xdrType, xdrUnit, parseDdmm, invalid, checksum, slice$ = [].slice;
