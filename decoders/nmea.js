...
(function(){
  var ref$, dropWhile, takeWhile, span, drop, floor, splitAt, moment, puts, length, exspan, buffer, unpack, decoders, multiSplit, gnssMode, gsaMode, gsaCalc, vtgMode, xdrType, xdrUnit, parseDdmm, invalid, checksum, slice$ = [].slice;
